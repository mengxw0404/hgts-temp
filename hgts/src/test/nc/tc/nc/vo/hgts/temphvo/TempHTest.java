...
import nc.vo.hgts.temphvo.TempH;
...
public class TempHTest extends BaseTestCase {
  TempH tempH=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    tempH=NCLocator.getInstance().lookup(TempH.class);
  }
  ...
  public void getParentPKFieldName(  Map<String,ArrayList<String>> dp){
    ...
    String retObj="";
    retObj=tempH.getParentPKFieldName();
  ...
  public void getDefaultTableName(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=TempH.getDefaultTableName();
